								...
								<div class="col-md-12 cook-grid">
									<div class="cook3">
										...
										<br>
											...
											<form method="Post" action="consulta-grado2.php">

											<div class="row">
												<div class="col-md-4">
													<div><label for="select-native-1">Busca y seleccione el grado academico</label></div>
												</div>
												<div class="col-md-5">
											...
											<br>
												...
												include("conexion.php");
												    ...
												    where reporte.id_grado=".$id_grado)
